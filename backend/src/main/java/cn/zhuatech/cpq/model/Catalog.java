...
@Entity @Table(name="cpq_catalog") public class Catalog extends BaseEntity {
    ...
    protected Catalog(){} public Catalog(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
